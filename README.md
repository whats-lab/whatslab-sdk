...
| | traj | shape° | tip° | open-contact | GMC | LMC | ms |
|---|---|---|---|---|---|---|---|
| robotis kp | flex | 33.9 | 38.9 | **4.6** | 95.4 | 63.7 | 2.02 |
| robotis net | flex | **27.5** | **23.6** | 11.7 | 88.5 | **81.1** | **0.35** |
| robotis net | abd | 11.0 | 8.6 | 11.0 | 99.7 | 80.3 | **0.25** |
| orca kp | abd | 11.0 | 11.8 | 11.9 | 88.2 | **80.4** | 2.16 |
| orca net | abd | 12.9 | **11.7** | **11.1** | **91.6** | 41.0 | **0.25** |

`net` beats `kp` on robotis but not yet on orca — orca's abduction LMC (41.0) and
open-hand contact (16mm vs `kp` 1.6) are unresolved. Compare later changes against this
table.
